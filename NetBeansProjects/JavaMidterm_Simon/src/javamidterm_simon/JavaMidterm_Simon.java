...
public class JavaMidterm_Simon {
    ...
    public static void start() {
        ...
        System.out.print("[Y]: ");
        player.y = sc.nextInt();
        System.out.println("Are you sure you want to start at " + player.getY() + "," + player.getX() + "?");
        sc.nextLine();
        sca = sc.nextLine();
        if (sca.contains("y")) {
            System.out.println("\nOkay, Here we go!");         
    ...
    public static void math() {
        ...
        int e = r.nextInt(1000) + 1;
        int f = r.nextInt(1000) + 1;
        int g = r.nextInt(1000) + 1;
        int h = r.nextInt(1000) + 1;

        int ans = (h-(a/b) + d*(e/f*g))/c;
